...
@section('content')
    <div class="pt-20 p-4 sm:ml-0">
        ...
        <div class="mb-4 p-6 bg-white shadow-md rounded-lg flex flex-col sm:flex-row justify-between items-center">
            <form action="{{ route('stock') }}" method="GET" class="flex-grow sm:mr-4 mb-4 sm:mb-0">
                <div class="relative">
            ...
            <button data-modal-target="addItemModal" data-modal-toggle="addItemModal" type="button"
                class="w-full sm:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 @if ($user->role_id != '1') hidden @endif focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">
                Tambah Barang Baru
            </button>
        </div>
