        ...
        <div class="bg-white shadow-md rounded-lg overflow-x-auto">
            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4 text-center">
                                <form action="{{ route('stock.fulfill', $order->id) }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="font-medium text-white bg-green-600 hover:bg-green-700 rounded-lg px-4 py-2 text-xs">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center p-4">Tidak ada pesanan stok yang menunggu.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
